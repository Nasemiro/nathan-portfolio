    ...
    <div className="about-container">
      <FloatingBox>
        <div className="about-text">
          ...
          <p>In 2022, while pursuing my studies, I worked as a Class Assistant and soon transitioned into a teaching role. From 2023 to early 2024, I served as a full-time educator, teaching Mathematics to Grades 6–9 and Information Technology to Grades 8–12. My responsibilities included delivering engaging lessons, maintaining academic records, and fostering a positive learning environment. I also served as the school's Table Tennis coach and supervised students during off-campus matches and events.
          </p>
        </div>
      </FloatingBox>
    </div>
